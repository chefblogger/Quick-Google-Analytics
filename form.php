...
function showForm_quickgoogleanalytics() {
  ...
  echo '<h2>Quick Google Analytics Code</h2>';
...
{ echo '<option selected value="1" >Old Google Analytics Code (UA-12345678-9)</option>';}
else
{ echo '<option value="1" >Old Google Analytics Code (UA-12345678-9)</option>';}
	
if ($quickgoogleanalytics_select_show == '2')
{ echo '<option selected value="2" >Old UA-Code & New G-Code (my recommendation)</option>';}
else
{ echo '<option value="2" >Old UA-Code & New G-Code (my recommendation)</option>';}

if ($quickgoogleanalytics_select_show == '3')
{ echo '<option selected value="3" >Only NEW Google Analytics 4 (G-ABCDEFGHIJ)</option>';}
else
{ echo '<option value="3" >Only NEW Google Analytics 4 (G-ABCDEFGHIJ)</option>';}
